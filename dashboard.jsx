...
const SAMPLE_DATA = {
  NWSC: {
    ...
    topics: [
      ...
      { name: 'Accelerator ramp', weight: 0.16, mgmt: 0.82, qa: 0.60 },
      { name: 'Margins', weight: 0.12, mgmt: 0.55, qa: 0.30 },
      { name: 'Sovereign AI', weight: 0.12, mgmt: 0.70, qa: 0.40 },
    ],
    extracts: [
      { tag: 'confident', speaker: 'CFO (fictional)', text: 'Accelerator demand exceeds our most aggressive supply forecasts.' },
      { tag: 'hedging', speaker: 'CEO (fictional)', text: "We're cautiously monitoring the regulatory environment in certain regions." },
  ...
  HRBS: {
    ...
    topics: [
      ...
      { name: 'Hardware lab', weight: 0.18, mgmt: 0.30, qa: -0.10 },
      { name: 'Capex', weight: 0.12, mgmt: 0.45, qa: 0.20 },
      { name: 'Regulatory', weight: 0.10, mgmt: 0.20, qa: 0.10 },
    ],
    extracts: [
      { tag: 'confident', speaker: 'CFO (fictional)', text: 'Ad performance continues to compound on improved targeting and ranking models.' },
      { tag: 'hedging', speaker: 'CEO (fictional)', text: 'AI infrastructure investments will continue at elevated levels for the foreseeable future.' },
      { tag: 'evasion', speaker: 'Management response', text: 'On the hardware lab path to profitability: "We see this as a multi-decade investment."' },
    ],
  },
  VLTW: {
    ...
    topics: [
      ...
      { name: 'Autonomy software', weight: 0.18, mgmt: 0.80, qa: 0.25 },
      { name: 'Margins', weight: 0.16, mgmt: 0.40, qa: 0.10 },
      { name: 'Energy', weight: 0.14, mgmt: 0.65, qa: 0.55 },
    ],
    extracts: [
      { tag: 'confident', speaker: 'CEO (fictional)', text: 'Unsupervised autonomy will be available in most markets this year.' },
      { tag: 'hedging', speaker: 'CFO (fictional)', text: 'Timing of robotaxi commercial launch depends on regulatory approvals across jurisdictions.' },
  ...
  GRFD: {
    ...
    extracts: [
      { tag: 'hedging', speaker: 'CEO (fictional)', text: 'We continue to make progress on our turnaround across all segments.' },
      ...
      { tag: 'admission', speaker: 'CFO (fictional)', text: 'We acknowledge our execution has not met our own expectations.' },
    ],
  },
};
